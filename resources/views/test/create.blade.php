            ...
            @endif
              ...
              <div class="card-body">
                ...
                <div class="form-group @error('total_questions') has-danger @enderror">
                    <label class="col-form-label" for="total_questions">Total Questions</label>
                    <input type="text" class="form-control @error('total_questions') is-invalid @enderror" id="total_questions" name="total_questions" value="{{ old('total_questions', $test->total_questions) }}" placeholder="Total Questions (default 10)" required>
