...
<form action="{{url('update-image/'.$poster->id)}}" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" class="form-control" name="title" value="{{$poster->title }}" required> <br>
    </div>
    <div class="form-group>
      <label class="col-form-label" for="link">Link</label><br>
    <input type="text" class="form-control" name="link"  value="{{$poster->link }}" required><br>
    </div>
    <div class="form-group>
    ...
    <div class="form-group>
      ...
      <select name="category" class="form-control"  value="{{$poster->category }}" required>
    ...
    <input type="text" class="form-control" name="discription"  value="{{$poster->discription }}" required><br>
    </div>
    <div class="form-group>
      <label class="col-form-label" for="status">status</label><br>
      <select name="status" class="form-control" value="{{$poster->status }}" required>
        <option value="" disabled selected>Choose option</option>
